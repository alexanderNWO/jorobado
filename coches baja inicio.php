        ...
        <br><br><br>
          <section class="service-area">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/baratos1.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Chevi 2012</h4>
                      <p>
                        Estandar<br>
                                  5 Pasajeros<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/baratos2.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Chevrolet Corsa</h4>
                      <p>
                        Estandar<br>
                                  5 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/baratos3.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Nissan Tsuru 2018</h4>
                      <p>
                        Estandar<br>
                                  5 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/baratos4.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Escarabajo 2003</h4>
                      <p>
                        Estandar<br>
                                  4 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/baratos5.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Pointer 2008</h4>
                      <p>
                        Estandar<br>
                                  5 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/baratos6.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Nissan Quest 2008</h4>
                      <p>
                        Automatico<br>
                                  7 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/baratos7.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Chrysler Voyager 2003</h4>
                      <p>
                        Automatico<br>
                                  8 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/baratos8.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Nissan NP300 2013</h4>
                      <p>
                        Estandar<br>
                                  2 Pasajeros<br>
