	...
	<div class="header">
        ...
        <br><br><br>
          <section class="service-area">
            <h1>COCHES Estándar</h1>
            <div class="container">
              <div class="row">
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/estandar1.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Nissan March 2019</h4>
                      <p>
                        Estandar<br>
					5 Pasajeros<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/estandar2.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Chevrolet Aveo 2018</h4>
                      <p>
                        Estandar<br>
                                  5 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/estandar3.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Cavalier 2019</h4>
                      <p>
                        Estandar<br>
                                  5 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/estandar4.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Nissan Versa 2018</h4>
                      <p>
                        Estandar<br>
                                  5 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/estandar5.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Nissan Tida 2017</h4>
                      <p>
                        Estandar<br>
                                  5 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/estandar6.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Nissan Sentra 2018</h4>
                      <p>
                        Automatico<br>
                                  4 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/estandar7.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Hyundai 2019</h4>
                      <p>
                        Automatico<br>
                                  5 Pasajeros<br>
                                  Con Portaequipaje<br>
                ...
                <div class="col-md-6">
                  <div class="single-service" style="background: url(images/estandar8.jpg);">
                    <div class="overlay overlay-content">
                      <h4 class="text-uppercase">Ford Lobo 2016</h4>
                      <p>
                        Automatico<br>
                                  5 Pasajeros<br>
