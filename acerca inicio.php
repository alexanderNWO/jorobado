			...
			<div class="w3l_banner_info">
				<div class="col-md-7 slider">
					<div class="callbacks_container">
                      ...
                      <h4>MISION</h4>
           <p>Ser una empresa en la cual las personas se sientan seguros disfrutando de su viaje. Así como el de ser un líder en el negoció estatal en la renta de autos  a través del  liderazgo teniendo una cultura de valores compartidos con la fuerza laboral y el desarrollo con asociados haciendo inversiones a nuestros vehículos para ser la empresa favorita por parte de los clientes en la renta de un auto.</p>
										</div>
									...
									<li>
										<div class="slider_banner_info">
                      <h4>VISION</h4>
						<p>Ser una empresa preferida para rentar vehículos los cuales les ayuden a las personas a favorecer su movilidad en el Estado de México (EDOMÉX).</p>
										</div>
